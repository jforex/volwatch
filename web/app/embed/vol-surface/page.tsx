...
export default function VolSurfaceEmbed() {
      ...
      <div className="rounded border border-neutral-800 bg-neutral-900 overflow-hidden">
        <div className="border-b border-neutral-800 px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-mono text-xs uppercase tracking-widest text-neutral-300 font-bold">VOL SURFACE</span>
        ...
        <div className="h-[480px]">
          <VolSurface3D oracles={oracles} now={liveNow} />
        </div>
      </div>
    </main>
  );
